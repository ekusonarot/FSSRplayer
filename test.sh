...
videos="BBB24fps/BBB24fps_144p.mp4"
...
do
python3 FSSRplayer.py -m FSSRv2 -c -u http://${server}/BBB24fps/BBB24fps_144p.mp4 -e -s $size
...
COMMENT
<< COMMENT
python3 FSSRplayer.py -m FSSRv2 -c -u http://${server}/ToS/ToS_270p.mp4 -e
...
python3 FSSRplayer.py -m NSSRv2 -c -u http://${server}/ToS/ToS_270p.mp4 -e
...
python3 FSSRplayer.py -m FSSRv2 -c -u http://${server}/BBB24fps/BBB24fps_270p.mp4 -e
...
python3 FSSRplayer.py -m NSSRv2 -c -u http://${server}/BBB24fps/BBB24fps_270p.mp4 -e
...
python3 FSSRplayer.py -m NSSRv2 -c -u http://${server}/HH/HH_270p.mp4 -e
